...
const server = app.listen(process.env.PORT || 3000, () => console.log(`Server started listening at ${process.env.PORT || 3000}`));
...
// data.forEach( d => {
//     let r = `INSERT INTO public.data(
//         name, image, description, "dateLastEdited")
//         VALUES ('${d.name}', '${d.image}', '${d.description}', '${d.dateLastEdited}');
//         `;
//     console.log(r)
// })
